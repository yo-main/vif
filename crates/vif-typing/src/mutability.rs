...
//     match stmt {
//         Stmt::Var(v) => {
//             let value_is_mutable = check_expression(&v.value)?;

//             if v.mutable && !v.value.typing.mutable {
...
// fn check_expression(expr: &Expr) -> Result<bool, TypingError> {
//     match &expr.body {
//         ExprBody::Call(c) => {
//             let value_is_mutable = check_expression(&c.callee)?;

//             // for arg in c.arguments.iter() {
//             //     check_expression(arg)?;
//             // }

//             let callable = match &c.callee.typing {
//                 Type::Callable(c) => c,
//                 _ => panic!("{} is not callable: {}", c.callee, c.callee.typing),
//             };

//             if let Some(signature_params) = callable.get_params() {
